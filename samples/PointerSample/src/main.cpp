...
int main()  // main function
{
    ...
    my_struct_t * my_struct_heap_ptr;  // This line of code is a declaration. It’s telling the compiler
                                       // that we’re going to use a variable named my_struct_heap_ptr, and this variable
                                       // is a pointer to a type called my_struct_t
    my_struct_heap_ptr =
        new my_struct_t;  // using the new operator to create a new instance of my_struct_t on the heap,
